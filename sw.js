...
const CACHE_VERSION = "lingzhi-1.1.11";
const PRECACHE_URLS = [
  "./",
  "./index.html",
  "./manifest.json",
...
self.addEventListener("fetch", function (event) {
  ...
  //    - 聊天代理请求
  var isApiRequest =
    url.hostname.indexOf("chatlz.dpdns.org") !== -1 ||
    url.hostname.indexOf("agnes-ai.com") !== -1 ||
    url.pathname.indexOf("/api/") === 0 ||
    url.pathname.indexOf("/v1/chat/completions") !== -1;
  if (isApiRequest) {
    return;
  }
